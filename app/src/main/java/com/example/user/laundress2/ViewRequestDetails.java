        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_ALL,
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if (success.equals("1")){
                                ...
                                {
                                    String trans_Service=jsonArray2.getJSONObject(i).getString("trans_Service").toString();
                                    String trans_ExtService=jsonArray2.getJSONObject(i).getString("trans_ExtService").toString();
                                    String trans_ServiceType=jsonArray2.getJSONObject(i).getString("trans_ServiceType").toString();
                                    String trans_EstWeight=jsonArray2.getJSONObject(i).getString("trans_EstWeight").toString();
                                    String trans_EstDateTime=jsonArray2.getJSONObject(i).getString("trans_EstDateTime").toString();
                                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT, 1);
                                    //llhori.setOrientation(LinearLayout.HORIZONTAL);

                                    TextView tv = new TextView(ViewRequestDetails.this);
                                    tv.setText(trans_Service);
                                    tv.setPadding(10, 10, 10, 10);
                                    llreqserv.addView(tv);
                                    TextView tv1 = new TextView(ViewRequestDetails.this);
                                ...
                                Toast.makeText(ViewRequestDetails.this, "No data",  Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e){
                            e.printStackTrace();;
                            Toast.makeText(ViewRequestDetails.this, " Failed " + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ViewRequestDetails.this, "Failed " + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
