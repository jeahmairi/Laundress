...
public class ConfirmLaundryDetails extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btncancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ConfirmLaundryDetails.this, CancelBookingHandwasher.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_ALL,
                        ...
                        try{
                            ...
                            if (success.equals("1")){
                                ...
                                for (int i =0;i<jsonArray2.length();i++)
                                {
                                    ...
                                    llhori = new LinearLayout(ConfirmLaundryDetails.this);
                                    llhori.setOrientation(LinearLayout.HORIZONTAL);
                                    llhori.setPadding(5, 5, 5, 5);

                                    CheckBox cb = new CheckBox(ConfirmLaundryDetails.this);
                                    cb.setChecked(false);
                                    cb.setTag(cinv_ID);
                                    ...
                                    llhori.addView(cb);
                                    ImageView tv = new ImageView(ConfirmLaundryDetails.this);
                                    Picasso.get().load(cinv_ItemTag).into(tv);
                                    llhori.addView(tv);

                                    TextView tv1 = new TextView(ConfirmLaundryDetails.this);
                                    tv1.setText(description);
                                    tv1.setLayoutParams(params);
                                    tv1.setGravity(Gravity.CENTER);
                                    llhori.addView(tv1);

                                    TextView tv2 = new TextView(ConfirmLaundryDetails.this);
                                ...
                                Toast.makeText(ConfirmLaundryDetails.this, "No data",  Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e){
                            e.printStackTrace();;
                            Toast.makeText(ConfirmLaundryDetails.this, " Failed " + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ConfirmLaundryDetails.this, "Failed " + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if(success.equals("1")){
                                ...
                                Toast.makeText(ConfirmLaundryDetails.this, "Laundry Details Confirmed ", Toast.LENGTH_SHORT).show();
                                Bundle extras = new Bundle();
                                extras.putString("name",names);
                                extras.putInt("id", handwasher_id);
                                extras.putInt("lspid", lsp_id);
                                Intent intent = new Intent(ConfirmLaundryDetails.this, HandwasherHomepage.class);
                                intent.putExtras(extras);
                                startActivity(intent);
                            }
                        } catch (JSONException e){
                            e.printStackTrace();;
                            Toast.makeText(ConfirmLaundryDetails.this, "Update Failed " + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ConfirmLaundryDetails.this, "Update Failed " + error.toString(), Toast.LENGTH_SHORT).show();
