...
public class ShopConfirmBooking extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Toast.makeText(ShopConfirmBooking.this, "Updated trans_no " +trans_No, Toast.LENGTH_SHORT).show();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if(success.equals("1")){
                                Toast.makeText(ShopConfirmBooking.this, "Laundry Details Confirmed ", Toast.LENGTH_SHORT).show();
