        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_ALL_ClIENTS,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")){
                                ...
                                Toast.makeText(ViewClients.this, "error " , Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(ViewClients.this, "failedddd" +e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ViewClients.this, "Failed. No Connection. " + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
