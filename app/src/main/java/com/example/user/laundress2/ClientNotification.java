...
/*                String updatemessage = message.getText().toString().trim();
    ...
    private void addRatingShop(int client_id, int lsp_id, int trans_no, float accommodation, float qualityofservice, float ontime, float overall, String comments) {
